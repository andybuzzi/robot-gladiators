...
var fight = function (enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    // generates random demage value based on player's attack power
    ...
    // generates random demage value based on enemy's attack power
...
var endGame = function () {
  ...
  if (playerInfo.health > 0) {
    window.alert(
      "Great Job, you've survived the game! You know have a score of " +
        playerInfo.money +
        "."
    );
  } else {
  ...
  var playAgainConfirm = window.confirm("Would like to play again?");
